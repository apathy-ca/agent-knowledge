...
- [Worker Definition Template](../../templates/templates/agent-project-template.md)
- [Worker Identity Template](../../templates/templates/agent-project-template.md)
- [Worker Closeout Template](../../templates/templates/agent-project-template.md)
