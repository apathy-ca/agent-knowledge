...
| **Worker Identity Template** | Template for worker identity files | [templates/worker-identity-template.md](../templates/agent-project-template.md) |
| **Worker Definition Template** | Template for worker task definitions | [templates/worker-definition-template.md](../templates/agent-project-template.md) |
| **Worker Closeout Template** | Template for worker completion reports | [templates/worker-closeout-template.md](../templates/agent-project-template.md) |
...
|----------|-------------|------|
| **Python Project** | Python project structure and setup | [python-project-template.md](../templates/agent-project-template.md) |
| **Agent Project** | Agent-based project template | [agent-project-template.md](../templates/agent-project-template.md) |
| **Repository Structure** | Standard repository organization | [repository-structure-template.md](../templates/agent-project-template.md) |

### Documentation Templates

| Template | Description | Path |
|----------|-------------|------|
| **README Template** | Comprehensive README structure | [readme-template.md](../templates/agent-project-template.md) |
| **API Documentation** | API documentation format | [api-documentation-template.md](../templates/agent-project-template.md) |
| **Architecture Docs** | Architecture documentation template | [architecture-documentation-template.md](../templates/agent-project-template.md) |

### Testing Templates

| Template | Description | Path |
|----------|-------------|------|
| **Unit Test** | Unit test structure and patterns | [unit-test-template.md](../templates/agent-project-template.md) |
| **Integration Test** | Integration test template | [integration-test-template.md](../templates/agent-project-template.md) |
| **Test Fixture** | Test fixture and data template | [test-fixture-template.md](../templates/agent-project-template.md) |

### Worker Templates

| Template | Description | Path |
|----------|-------------|------|
| **Worker Identity** | Worker identity file template | [worker-identity-template.md](../templates/agent-project-template.md) |
| **Worker Definition** | Worker task definition template | [worker-definition-template.md](../templates/agent-project-template.md) |
| **Worker Closeout** | Worker completion report template | [worker-closeout-template.md](../templates/agent-project-template.md) |
